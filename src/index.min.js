...
customElements.define("z-workspace-picker", class extends i4 {
  ...
  render() {
    return x`<sl-dropdown @sl-select=${this.handleSelect}>
...
var import_lit115 = __toESM(require_lib(), 1);
customElements.define("z-settings-dialog", class extends i4 {
  #open = new import_lit115.StoreController(this, $settingsDialog);
  static styles = i``;
  render() {
...
customElements.define("z-workspace-edit-dialog", class extends i4 {
  #open = new import_lit117.StoreController(this, $newWorkspaceDialog);
  static styles = i``;
  render() {
