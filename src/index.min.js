...
function openSettings() {
  $ui.setKey("settings", true);
}
function closeSettings() {
  $ui.setKey("settings", false);
}
function openNewWorkspace() {
  $ui.setKey("newWorkspace", true);
}
function closeNewWorkspace() {
  $ui.setKey("newWorkspace", false);
}
...
customElements.define("z-settings-dialog", class extends i4 {
  #ui = new import_lit115.StoreController(this, $ui);
  static styles = i``;
  handleClose(evt) {
    evt.preventDefault();
    closeSettings();
  ...
  render() {
    return x`<sl-dialog label="Settings" .open=${this.#ui.value.settings} @sl-request-close=${this.handleClose}>
...
customElements.define("z-workspace-edit-dialog", class extends i4 {
  #ui = new import_lit117.StoreController(this, $ui);
  static styles = i``;
  handleClose(evt) {
    evt.preventDefault();
    closeNewWorkspace();
  ...
  render() {
    ...
    return x`<sl-dialog label=${label} .open=${this.#ui.value.newWorkspace} @sl-request-close=${this.handleClose}>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
